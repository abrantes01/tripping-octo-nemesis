...
ini_set('display_errors', 1);
    ...
    if (isset($_GET['section'] ) )
    {
        ...
        {
            $controller_file = dirname(__FILE__).'/controllers/'.ucfirst($_GET['section']).'Controller.php';

            if ( is_file($controller_file))
            {
                include $controller_file ;
                $controller = ucfirst($_GET['section']).'Controller' ;
            ...
            include 'controllers/ManifestationController.php';
